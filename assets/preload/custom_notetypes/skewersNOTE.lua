function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'skewersNOTE' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'skewersNOTE_assets'); --Change texture
